...
const GrokSettingSchema = z.object({
...
type GrokSettingForm = z.infer<typeof GrokSettingSchema>;
...
const GrokSetting = ({
    ...
    onSubmit?: (data: GrokSettingForm) => void;
    variableName?: string;
    credentialId?: string;
    systemPrompt?: string;
    userPrompt?: string;
}) => {
    const form = useForm<GrokSettingForm>({
        resolver: zodResolver(GrokSettingSchema),
        defaultValues: {
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="space-y-2">
                                    ...
                                    <FormControl>
                                        <Input placeholder="GrokAIcall" {...field} />
                                    </FormControl>
                        ...
                        />
                         ...
                         <FormField
                                                    ...
                                                    render={({ field }) => {
                                                        ...
                                                        const GrokCreds = data?.filter((c) => c.type === "GROK") || []
                                                                        ...
                                                                        <DropdownMenuTrigger asChild>
                                                                            ...
                                                                            >
                                                                                ...
                                                                                <span className="text-sm truncate">
                                                                                    {selected?.key || "Select Grok credential"}
                                                                                </span>
                                                                            </Button>
                                                                        </DropdownMenuTrigger>
