...
type OpenAISettingForm = z.infer<typeof OpenAISettingSchema>;
...
const OpenAISetting = ({
    ...
    onSubmit?: (data: OpenAISettingForm) => void;
    variableName?: string;
    credentialId?: string;
    systemPrompt?: string;
    userPrompt?: string;
}) => {
    const form = useForm<OpenAISettingForm>({
        resolver: zodResolver(OpenAISettingSchema),
        defaultValues: {
                    ...
                    >
                        ...
                        <FormField
                            ...
                            render={({ field }) => {
                                ...
                                const OpenAICreds = data?.filter((c) => c.type === "OPENAI") || []
                                                ...
                                                <DropdownMenuTrigger asChild>
                                                    ...
                                                    >
                                                        ...
                                                        <span className="text-sm truncate">
                                                            {selected?.key || "Select OpenAI credential"}
                                                        </span>
                                                    </Button>
                                                </DropdownMenuTrigger>
